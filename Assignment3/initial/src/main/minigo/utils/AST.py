...
class VarDecl(Decl, BlockMember):
    ...
    def __str__(self):
        return (
            "VarDecl("
            + self.varName
            + (("," + str(self.varType)) if self.varType else "")
...
class ConstDecl(Decl, BlockMember):
    ...
    def __str__(self):
        return (
            "ConstDecl("
            + self.conName
            + (("," + str(self.conType)) if self.conType else "")
            + ","
            + str(self.iniExpr)
            + ")"
        )
...
class ArrayType(Type):
    ...
    def __str__(self):
        return (
            ...
            + str(self.eleType)
            + ",["
            + ",".join(str(i) for i in self.dimens)
            + "])"
        )
...
class StructType(Type):
    ...
    def __str__(self):
        return (
            ...
            + self.name
            + ",["
            + ",".join(("(" + i + "," + str(j) + ")") for i, j in self.elements)
            + "],["
            + ",".join(str(i) for i in self.methods)
            + "])"
        )
...
class BinaryOp(Expr):
    ...
    def __str__(self):
        return (
            "BinaryOp(" + str(self.left) + "," + self.op + "," + str(self.right) + ")"
        )
...
class StructLiteral(Literal):
    ...
    def __str__(self):
        return (
            ...
            + self.name
            + ",["
            + ",".join(("(" + str(i) + "," + str(j) + ")") for i, j in self.elements)
            + "])"
        )
